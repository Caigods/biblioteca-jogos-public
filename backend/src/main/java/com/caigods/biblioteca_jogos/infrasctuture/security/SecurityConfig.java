...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/swagger-ui/**").permitAll()        // ← adicionar
                        .requestMatchers("/swagger-ui.html").permitAll()      // ← adicionar
                        .requestMatchers("/v3/api-docs/**").permitAll()       // ← adicionar
                        .requestMatchers(HttpMethod.GET, "/usuario").permitAll()
                        .requestMatchers("/error").permitAll() // Permite que mensagens de erro sejam enviadas
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of(
                "http://localhost:5174",
                "http://localhost:5173",// Seu Frontend local (Vite/React?)
